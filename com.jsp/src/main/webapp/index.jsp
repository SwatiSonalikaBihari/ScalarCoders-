...
<section class="home" id="home">
	<nav class="main-navbar">
		...
		<a href="#" class="get-started-btn-container">
			...
			<ul class="nav-list">
			<form action="login">
			<input class="login" type="submit" value="login/register"> 
...
<section class="courses" id="courses">
	...
	<div class="course-contents">
		...
		<div class="course-card">
			...
			<div class="category">
				<div class="subject"><h3>java</h3></div>
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="java" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
		...
		<div class="course-card">
			<img justify-content="centre" src="js.png">
			<div class="category">
				<div class="subject"><h3>JavaScript</h3></div>
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="javascript" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
			</div>
		...
		<div class="course-card">
			<img src="Mysql.png">
			<div class="category">
				<div class="subject"><h3>MySQL</h3></div>
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="mysql" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
			</div>
		...
		<div class="course-card">
			...
			<div class="category">
				...
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="web_development" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
			</div>
		...
		<div class="course-card">
			<img src="DBMS.png">
			<div class="category">
				<div class="subject"><h3>DBMS</h3></div>
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="dbms" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
			</div>
		...
		<div class="course-card">
			...
			<div class="category">
				<div class="subject"><h3>System Design</h3></div>
				<div >
				<form action="enroll">
				<input type="text" style="display: none;" value="system_design" name="subject">
				<input type="submit" value="Enroll" class="subject">
				</form>
				</div>
			</div>
		...
		<div class="footer-col footer-col-2">
			...
			<div class="col-contents">
				<div class="contact-row">
					<span>Address</span>
					<span>1234 Street, Bhubaneswar, India</span>
				</div>
				<div class="contact-row">
					<span>Phone</span>
				...
				<div class="contact-row">
					<span>Website</span>
					<span>ScalarCoder.com</span>
				</div>
				<div class="contact-row">
					<span>Email</span>
					<span>scalarcoder@gmail.com</span>
				</div>
			</div>
		</div>
